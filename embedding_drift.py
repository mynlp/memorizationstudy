...
for token in range(2, 17):
    ...
    distance_list_full.append(float(distance_full.cpu()))
    distance_list_ninety.append(float(distance_ninety.cpu()))
    distance_list_eighty.append(float(distance_eighty.cpu()))
    distance_list_seventy.append(float(distance_seventy.cpu()))
    distance_list_sixty.append(float(distance_sixty.cpu()))
    distance_list_fourty.append(float(distance_fourty.cpu()))
    distance_list_thirty.append(float(distance_thirty.cpu()))
    distance_list_twenty.append(float(distance_twenty.cpu()))
    distance_list_ten.append(float(distance_ten.cpu()))
    distance_list_zero.append(float(distance_zero.cpu()))
