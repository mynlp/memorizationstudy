...
for token in range(2, 17):
    ...
    distance_list_full.append(distance_full)
    distance_list_ninety.append(distance_ninety)
    distance_list_eighty.append(distance_eighty)
    distance_list_seventy.append(distance_seventy)
    distance_list_sixty.append(distance_sixty)
    distance_list_half.append(averaged_embedding_half)
    distance_list_fourty.append(distance_fourty)
    distance_list_thirty.append(distance_thirty)
    distance_list_twenty.append(distance_twenty)
    distance_list_ten.append(distance_ten)
    distance_list_zero.append(distance_zero)
