...
for token in range(2, continuation_size+1):
    ...
    embeddings = [predicted_embedding_full.mean(0)[token-2], predicted_embedding_ninety.mean(0)[token-2],
                  predicted_embedding_eighty.mean(0)[token-2], predicted_embedding_seventy.mean(0)[token-2],
                  predicted_embedding_sixty.mean(0)[token-2], predicted_embedding_half.mean(0)[token-2],
                  predicted_embedding_forty.mean(0)[token-2], predicted_embedding_thirty.mean(0)[token-2],
                  predicted_embedding_twenty.mean(0)[token-2], predicted_embedding_ten.mean(0)[token-2],
                  predicted_embedding_zero.mean(0)[token-2]]
    ...
    distance_list_full.append(-float(distance_full.cpu()) if tsne_embeddings[0, 0] < tsne_embeddings[5, 0] else float(distance_full.cpu()))
    distance_list_ninety.append(-float(distance_ninety.cpu()) if tsne_embeddings[1, 0] < tsne_embeddings[5, 0] else float(distance_ninety.cpu()))
    distance_list_eighty.append(-float(distance_eighty.cpu()) if tsne_embeddings[2, 0] < tsne_embeddings[5, 0] else float(distance_eighty.cpu()))
    distance_list_seventy.append(-float(distance_seventy.cpu()) if tsne_embeddings[3, 0] < tsne_embeddings[5, 0] else float(distance_seventy.cpu()))
    distance_list_sixty.append(-float(distance_sixty.cpu()) if tsne_embeddings[4, 0] < tsne_embeddings[5, 0] else float(distance_sixty.cpu()))
    distance_list_fourty.append(-float(distance_fourty.cpu()) if tsne_embeddings[6, 0] < tsne_embeddings[5, 0] else float(distance_fourty.cpu()))
    distance_list_thirty.append(-float(distance_thirty.cpu()) if tsne_embeddings[7, 0] < tsne_embeddings[5, 0] else float(distance_thirty.cpu()))
    distance_list_twenty.append(-float(distance_twenty.cpu()) if tsne_embeddings[8, 0] < tsne_embeddings[5, 0] else float(distance_twenty.cpu()))
    distance_list_ten.append(-float(distance_ten.cpu()) if tsne_embeddings[9, 0] < tsne_embeddings[5, 0] else float(distance_ten.cpu()))
    distance_list_zero.append(-float(distance_zero.cpu()) if tsne_embeddings[10, 0] < tsne_embeddings[5, 0] else float(distance_zero.cpu()))
...
print(distance_list_eighty)
print(distance_list_seventy)
print(distance_list_sixty)
print(distance_list_fourty)
print(distance_list_thirty)
print(distance_list_twenty)
