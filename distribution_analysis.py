...
num_points = 30
highest_probability_memorized = logits_obtain(random.sample(idx_full_memorization,num_points), model, 32, 16)
highest_probability_unmemorized = logits_obtain(random.sample(idx_not_full_memorization,num_points), model, 32, 16)
